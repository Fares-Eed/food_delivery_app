    ...
    return Scaffold(
     ...
     Center(
      child: Column(
        children: [
        SizedBox(height: 85),
      Text('Sign Up', style: TextStyles.size30),
        SizedBox(height: 10),
...
Text('Name', style: TextStyles.size13.copyWith(color:AppColors.black2)),
        SizedBox(height: 10),
TextFormField(
...
SizedBox(height: 24),
Text('Re-Type Password', style: TextStyles.size13.copyWith(color: AppColors.black2)),
        SizedBox(height: 10),
